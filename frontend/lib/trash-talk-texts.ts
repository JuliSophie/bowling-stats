...
// Positive diff = avg > median (high outliers inflate average, typical game is worse)
// Negative diff = median > avg (bad outliers drag average down, typical game is better)
...
// --- Median vs. average: consistency indicator ---
